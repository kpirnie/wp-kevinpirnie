    ...
    class KPT_Settings {
        ...
        */
        public function add_settings( ) : void {
            ...
            add_action( 'csf_loaded', function( ) : void {

                var_dump('---------------------------------fw loaded');echo '<hr />';
                // create the theme settinngs
        ...
        */
        private function create_theme_settings( ) : void {
            ...
            if( class_exists( 'CSF' ) ) {
                ...
                CSF_Setup::createOptions( $settings_id, array(
                ...
                CSF_Setup::createSection( $settings_id, 
                    array(
