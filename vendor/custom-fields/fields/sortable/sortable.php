 ...
 *
 */
if ( ! class_exists( 'KPT_FW_Field_sortable' ) ) {
  class KPT_FW_Field_sortable extends KPT_FW_Fields {
    ...
    public function render() {
      ...
      echo '<div class="kpt_fw-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="kpt_fw-sortable-item">';

          echo '<div class="kpt_fw-sortable-content">';
          ...
          KPT_FW::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="kpt_fw-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
