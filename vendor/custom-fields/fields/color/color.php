 ...
 *
 */
if ( ! class_exists( 'KPT_FW_Field_color' ) ) {
  class KPT_FW_Field_color extends KPT_FW_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="kpt_fw-color"'. $default_attr . $this->field_attributes() .'/>';
