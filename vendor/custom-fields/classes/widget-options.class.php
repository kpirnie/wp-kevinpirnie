 ...
 *
 */
if ( ! class_exists( 'KPT_FW_Widget' ) ) {
  class KPT_FW_Widget extends WP_Widget {
    ...
    public function __construct( $key, $params ) {
      ...
      $this->unique = $key;
      $this->args   = apply_filters( "kpt_fw_{$this->unique}_args", wp_parse_args( $params, $this->args ), $this );
      ...
      // Set filters
      $widget_ops  = apply_filters( "kpt_fw_{$this->unique}_widget_ops", $widget_ops, $this );
      $control_ops = apply_filters( "kpt_fw_{$this->unique}_control_ops", $control_ops, $this );
    ...
    public function form( $instance ) {
      ...
      if ( ! empty( $this->args['fields'] ) ) {
        ...
        echo '<div class="kpt_fw kpt_fw-widgets kpt_fw-fields'. esc_attr( $class ) .'">';
        ...
        foreach ( $this->args['fields'] as $field ) {
          ...
          KPT_FW::field( $field, $this->get_widget_value( $instance, $field ), $field_unique );
    ...
    public function update( $new_instance, $old_instance ) {
      ...
      $new_instance = apply_filters( "kpt_fw_{$this->unique}_save", $new_instance, $this->args, $this );

      do_action( "kpt_fw_{$this->unique}_save_before", $new_instance, $this->args, $this );
